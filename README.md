...
Collaborative scheduling and polling
...
- **rallly**: rallly/rallly:latest

### Infrastructure Components

- **rallly-db**: Postgres database
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/rallly/main/docker-compose.yaml" -o compose.yml
```
